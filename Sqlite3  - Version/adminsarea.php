               ...
               elseif(isset($_GET['action'])&&$_GET['action']=="SendToRIS"){
                  ...
                  foreach($userslist as $v){
                     echo '<a class="btn btn-primary" href="'."{$_SERVER['PHP_SELF']}?action=viewlist&uname={$v['uname']}".
                              '" role="button">'.$v['uname'].' [View / Download List]</a>';
                     echo '&nbsp;';
                     echo "<a onClick=\"return confirm('You are about to mark off all requested procedures from {$v['uname']}. Continue?')\" ";
               ...
               <div class="col-md-6">
                  ...
                  <div class="jumbotron">
                     <form id="add-user-tbl" class="form-inline" onsubmit="return submitForm();">
                       ...
                       <button type="submit" class="btn btn-info" disabled>Add User</button>
                       <input type="hidden" name="submit-type" value="add-user-perm" >
                     </form>
                     <p>&nbsp;No end users for now</p>
                    <div id="echo-results">
